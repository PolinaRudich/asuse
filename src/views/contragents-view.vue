  ...
  <div id="contracts-view">
    <div class="contracts-content">
      <div style="display: flex">
        <div class="content-h">Реестр контрагентов</div>
      ...
      <div class="contract-grid-container">
        <div class="side-navigation-menu-c" :style="!openState && 'margin-left: 30px'">
          ...
          <transition name="slide">
            <SearchDrawer v-if="openState" :show-abn="true"/>
          </transition>
        </div>
        <ContragentsGrid
...
function getMainMenuHeight() {
  ...
  if (mainMenu && currentLayout) {
    ...
    if (mainMenu.clientWidth > 1172) {
      ...
      currentLayout.style.height = `calc(100% - ${mainMenu.clientHeight + 80}px)`
    }
...
export default {
  ...
  setup() {
    ...
    function onCellPrepared(e) {
      //console.log("onRowPrepared")
      //e.cellElement.style.padding = "1px";
      if (e.rowType === 'header') {
